...
export default class RequestDetails extends Component {
    ...
    render() {
        ...
        var objects = this.state.info ? this.state.info.objects : null;
            ...
            <div className={classes} onClick={this._onClick}>
                <div className="request-details-inner">
                    <div className="tabs">
                        ...
                        <div className="tab" onClick={this._go(5)}>
                            Session
                        </div>
                    </div>
                    ...
                    <div className="panels" style={panelStyle}>
                        ...
                        <div className="panel response">
                            <pre><strong>headers:</strong> {prettify(response.headers)}</pre>
                        </div>
                        <div className="panel session">
                            <pre>{prettify(session)}</pre>
                        </div>
                    </div>
                </div>
            </div>
